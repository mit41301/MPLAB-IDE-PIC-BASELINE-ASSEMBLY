;************************************************************************
;                                                                       *
;   Filename:      BA_L7-Flash_LED_ext32k.asm                           *
;   Date:          17/6/12                                              *
;   File Version:  1.4                                                  *
;                                                                       *
...
;************************************************************************
;                                                                       *
;   Description:    Lesson 7, example 4a                                *
;                                                                       *
;   Demonstrates external clock, using 32.768 kHz signal                *
;                                                                       *
...
;***** CONFIGURATION
                ; ext reset, no code protect, no watchdog, external clock
